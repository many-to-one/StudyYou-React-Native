    ...
    const setLanguage = async() => {
        ...
        if(lng === 'PL'){
            setTrans({
                ...
                'UsersManagment': 'Zarządzaj użytkownikami',
                'Admin': 'Administrator',
                'Leader': 'Starszy',
                'Helper': 'Przywileje',
                'Ministry': 'Prowadzoncy zbiorek',
                'Editor': 'Redaktor',
                'Report': 'Owoc',
                'Service': 'Serwis',
                'getMonthsResults': 'Raportacja(historia)',
            })
            ...
            setTrans({
                ...
                'Leader': 'Старейшина',
                'Helper': 'Помощник',
                'Ministry': 'Встречи для проповеди ',
                'Editor': 'Редактор',
                'Report': 'Отчёт',
                'Service': 'Сервис',
                'getMonthsResults': 'История отчётов',
            })
            ...
            setTrans({
                ...
                'Leader': 'Старійшина',
                'Helper': 'Помічник',
                'Ministry': 'Зустрічі для проповіді',
                'Editor': 'Редактор',
                'Report': 'Звіт',
                'Service': 'Сервіс',
                'getMonthsResults': 'Історія звітів',
            })
